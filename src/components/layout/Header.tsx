  ...
  return (
    ...
    >
      ...
      >
        <Link href="/">
          <h1
            className={`font-extralight text-2xl font-iCielAlina cursor-pointer ease-in duration-200 hover:scale-105 ${
        ...
        >
          {menuData.map((list) => (
            <li
              key={list.id}
              className="px-3 lg:px-4 py-2 ease-in font-montserrat duration-200 hover:text-chipo-heading"
            >
        ...
        <div className="flex gap-2 items-center">
          <Link href="/shop">
            <button
              className={`px-2  font-semibold  duration-200 py-1 text-[16px] lg:px-4 lg:py-2 border  mr-2 md:mr-5  hover:scale-105 ease-in cursor-pointer ${
                isScroll
                  ? "bg-chipo-heading border-white"
                  : "bg-chipo-bg-primary border-chipo-text"
              }`}
            >
              Book a table
            </button>
